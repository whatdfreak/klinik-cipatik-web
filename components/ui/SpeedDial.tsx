...
import { siteConfig } from "@/config/site"; // Menggunakan SSOT
...
export default function SpeedDial() {
  ...
  // [A11y & UX] Menutup menu dengan klik di luar (pointerdown untuk mobile) & tombol Escape
  useEffect(() => {
        ...
        >
          ...
          <AnimatePresence>
            {isOpen && (
              ...
              >
                {/* Action 1: Reservasi */}
                <Link href="/reservasi" role="menuitem" onClick={() => setIsOpen(false)} className="flex items-center gap-3 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded-full">
                ...
                {/* Action 2: WhatsApp */}
                <a href={`https://wa.me/${siteConfig.contact.wa}`} role="menuitem" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] rounded-full">
                ...
                {/* Action 3: Telepon */}
                <a href={`tel:${siteConfig.contact.phone}`} role="menuitem" className="flex items-center gap-3 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-full">
                ...
                {/* Action 4: Maps */}
                <a href={siteConfig.contact.mapsLink} role="menuitem" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 rounded-full">
